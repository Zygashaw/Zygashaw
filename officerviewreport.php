        ...
        <h4>View Report</h4> 
            ...
            if (isset($_GET["cid"]))
              ...
              $_SESSION['scid']=$cid;
                ...
                $get_job = "SELECT * FROM applicantresult where aid='$cid' ";
            ...
            <?php
...

                {
                  ...
                  $sql="SELECT * FROM applicantresult WHERE status3='Approved' AND status2='selected' AND status4='$workplace' AND aid='$aid'";
                    ...
                    if($c >= '1')
                    {
                      ...
                      <font style="margin-left:50px;">
                        ...
                        <a class="label btn btn-xs label-message" href="officerviewreport.php? recived=<?php echo $_SESSION['said'];?>" role="button">
                            <span class="glyphicon " aria-hidden="true">Recived</span>
                          </a>
                      </font>
                      <font style="margin-left:150px;">
                        <a class="label btn btn-xs label-message" href="officerviewreport.php? Notrec=<?php echo $_SESSION['said'];?>" role="button">
                            <span class="glyphicon " aria-hidden="true">Not Recived</span>
                          </a>
                      </font>
                      <?php
                }
        ...
        <?php
                ...
                if (isset($_GET["recived"]))
                  ...
                  $recived=$_GET["recived"];
                    ...
                    $sql1="UPDATE applicantresult SET Assign='Recived' WHERE aid='$aid'";
        ...
        <?php
                ...
                if (isset($_GET["Notrec"]))
                  ...
                  $Notrec=$_GET["Notrec"];
                    ...
                    $get_job = "SELECT * FROM applicantresult WHERE aid='$Notrec'";
                    $run_job = mysqli_query($con, $get_job);
                    while ($row_job=mysqli_fetch_array($run_job))
                     {
                    $aid=$row_job['aid'];
                    ...
                    $sql1="UPDATE applicantresult SET Assign='Not Recived' WHERE aid='$aid'";
                    $updated1=mysqli_query($con,$sql1);
                    if ($updated1) 
                    {
                      echo "Not Recived";
