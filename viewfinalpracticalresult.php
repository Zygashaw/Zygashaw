...
<html lang="">
	...
	<div class="container-fluid display-table">
	  ...
	  <header id="nav-header" class="clearfix">
       ...
       <div class="container">
	  <form action="viewfinalpracticalresult.php" method="post" enctype="multipart/form-data">
	    <div class="row">
	       ...
	       <div class="row">
            ...
            <li class="sidebar-search pull-right" style="margin-top:-33px; list-style-type:none;">
                <div class="input-group custom-search-form">
                    <input type="text" name="search1" class="form-control solomon" placeholder="No Of Stand By">
            ...
            <li class="sidebar-search pull-right" style="margin-top:-33px; list-style-type:none;">
                <div class="input-group custom-search-form">
                    <input type="text" name="jobtitle" class="form-control solomon" placeholder="Search Job Title">
                    <span class="input-group-btn">
                </div>
            </li>
			...
			$sql="SELECT * FROM applicantdoc,applicantresult WHERE applicantdoc.aid='$aid' AND 
								applicantresult.aid='$aid' ORDER BY total_grade";
			...
			$sql1=mysqli_query($con,"UPDATE applicantresult SET status2='selected' WHERE aid='$aid'");
				...
				$sql5=mysqli_query($con,"UPDATE applicantresult SET status2='selected' WHERE aid='$aid'");
	 if($count2<=$search1)
		 {
	...
	?>
      		...
      		<?php
				if($con)
				{
					...
					$sql="SELECT * FROM applicantresult ORDER By organaization_name AND total_grade DESC";
					...
					$app=$row['status3'];
					if ($interview>0 && $test>0 && $practical=' ' && $app!='Approved') {
			?>
