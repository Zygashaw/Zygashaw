...
<html lang="">
	...
	<div class="container-fluid display-table">
	  ...
	  <header id="nav-header" class="clearfix">
       ...
       <div class="container">
	  <form name="addem" action="registertestresult.php" method="post"  enctype="multipart/form-data">
	    <div class="row">
	     ...
	     <?php
	      ...
	      <?php
       	   ...
       	   ?>
       	   <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
	        <input type="text" name="bonus" hidden readonly value="0" placeholder=""/>
	        <div class="input-icon"><i class="fa fa-key"></i></div>
	      </div>
       	   <?php
       	} }
	      ...
	      <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
	        <input type="text" name="test" onkeyup="calculateTotal(test.value,bonus.value)" placeholder="Test (90%)" required/>
	        <div class="input-icon"><i class="fa fa-key"></i></div>
	      </div>
          ...
          if(isset($_POST["submit"]))
          {
            ...
            $total=$_POST["total"];
	            ...
	            if($total>100 or $total<0)
					...
					if($total<50)
					$sele="Not Selected For Inteview";
                ...
                $sql="INSERT INTO applicantresult VALUES(' ','$fullname','$orgname','$jobtitle','$sex','$testdate'
