...
<form action="" method="POST">
			        ...
			        <div class="input-icon"><i class="fa fa-key"></i></div>
		      		...
		      		<div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
			        <input type="password" name="old" Placeholder="Enter Your Current Password" autofocus/>
			        <div class="input-icon"><i class="fa fa-key"></i></div>
			      </div>
			      
			      <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
			        <input type="password" name="new" Placeholder="Enter Your New Password"/>
			        <div class="input-icon"><i class="fa fa-key"></i></div>
			      </div class="form-group">

			      <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
			        <input type="password" name="new1" Placeholder="Confirm New Password" />
			        <div class="input-icon"><i class="fa fa-key"></i></div>
			      </div>
