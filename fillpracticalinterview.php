...
<html lang="">
	...
	<div class="container-fluid display-table">
	  ...
	  <header id="nav-header" class="clearfix">
       ...
       <div class="container">
	  <form name="addem" action="fillpracticalinterview.php" method="post"  enctype="multipart/form-data">
	    <div class="row">
	      ...
	      <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
	        <input type="text" name="practical" readonly value="<?php echo "$practical"; ?>" placeholder="Test (90%)"/>
	        <div class="input-icon"><i class="fa fa-key"></i></div>
	      </div>
	      ...
	      <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
	        <input type="text" name="interview" placeholder="Interview Result" onkeyup="calculateTotal(total_grade.value,interview.value,bonus.value)"/>
	        <div class="input-icon"><i class="fa fa-key"></i></div>
	      </div>
	    ...
	    <?php
          if(isset($_POST["submit"]))
          {
            ...
            // // 	$sex="";
				...
				$sql1="UPDATE applicantresult SET interviewdate='$interviewdate',interview='$interview',total_grade='$total'
				,status2='$status2' WHERE aid='$aid'";
			    $updated=mysqli_query($con,$sql1);

                if($updated){
                  echo "<script> alert('Interview Registered successfully!') </script>";
                  echo "<script> window.open('fillpracticalinterview.php','_self') </script>";
              }
                else  
