  ...
  <div class="container-fluid display-table">
    ...
    <header id="nav-header" class="clearfix">
      ...
      <div class="col-md-7">
       ...
       <div class="container">
    <form action="registerlevel.php" method="post"  enctype="multipart/form-data">
      <div class="row">
        <h4>Register Job Level</h4>
        <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
          <input type="text" name="levelid" placeholder="Level Id" required/>
          <div class="input-icon"><i class="fa fa-user"></i></div>
        </div>
        <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
          <input type="text" name="leveltype" placeholder="level Type " required/>
          <div class="input-icon"><i class="fa fa-envelope"></i></div>
        </div>
        <div class="input-group input-group-icon" style="width:417px; margin-left:42px;">
          <input type="text" name="levelregdate" readonly value="<?php echo date("d/m/y"); ?> E.C" />
          <div class="input-icon"><i class="fa fa-envelope"></i></div>
        </div>
      ...
      <?php
          if(isset($_POST["submit"]))
          {
            ...
            if($con)
                $sql="insert into level values('$levelid','$leveltype','$levelregdate','$eid')";
                $inserted=mysqli_query($con, $sql);
                if($con)
                  echo "Job Level Registerd successfully!";
                else  
                  echo "Unable to Registerd" .mysqli_error();
           }       
      ?>
    </form>
