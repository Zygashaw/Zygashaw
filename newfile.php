    ...
    <div class="container">
      ...
      <?php
        if($con)
        {
            ...
            $sql="select jobtitle,organaization_name,workdescription,posted_date,postedby from postvacany order by `posted_date` DESC";
      ...
      ?>
            ...
            <p class="post-meta">Posted by
             ...
             <a class="label btn btn-xs label-message" href="post.php?" >
              <span >View Details</span>
             </a>
          
              
            <div class="input-group " style="width:; margin-left:;">
            <a href="register.php?" role="button">
              <input type="submit" name="submit" class="btn btn-primary" value="Apply Now!"/></a>
            </div>
              <hr></p>
